  ...
  return (
    <section className="pb-16 lg:py-24">
      <div className="container">
        ...
        <p className="text-center text-white/60 md:text-lg mt-4 max-w-md mx-auto lg:text-xl">See how I transformed concepts into engaging digital experiences.</p>
        <div className="flex flex-col md:mt-20 mt-10 flex flex-col gap-20">
          {portfolioProjects.map(project => (
            <div key={project.title} className="bg-gray-800 rounded-3xl relative z-0 overflow-hidden after:z-10 after:content-[''] after:absolute after:inset-0 after:outline-2 after:outline after:-outline-offset-2 after:rounded-3xl after:outline-white/20 px-8 md:pt-12 md:px-10 pt-8 after:pointer-events-none lg:pt-16 lg:px-20">
